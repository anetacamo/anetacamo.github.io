        ...
        <div className='blogs'>
          ...
          <div className='header'>
            ...
            <p>
              ...
              in React and Next JS with a lot of interest into designing and
              illustrating the layouts since I got introduced to basic HTML in
              2012.
            </p>
            <p>
              {' '}
              I have an eye on small details, smooth transitions and all sorts
              of details that can enhance the whole expirence of using a web or
              an application on all devices. I really enjoy building things with
              react, next, typescript and sass but also love to learn new things
              and am not afraid to set up own server or hook the web to any kind
              of database.
            </p>
            <h2>TOOLSTACK</h2>
